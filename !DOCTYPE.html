...
<html lang="en">
  <head>
    ...
    <title>Giulia Navarini - Luxury Skincare</title>
    ...
    >
      <div class="max-w-7xl mx-auto px-4">
        <nav class="flex items-center justify-between h-20">
          <a href="#" class="font-['Pacifico'] text-2xl">Giulia Navarini</a>
      ...
      <section class="relative h-[600px] bg-secondary overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 h-full flex items-center">
          <div class="max-w-xl">
            ...
            <a
              href="/shop"
              class="inline-block bg-primary text-white px-8 py-3 rounded-button text-lg hover:bg-primary/90 transition-colors"
              >Shop Now</a
            >
          </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="group relative">
              ...
              <div class="mt-4">
                <h3 class="text-lg font-medium">Giulia's Vitamin C Serum</h3>
                <p class="text-gray-600 text-sm mt-1">
            ...
            <div class="group relative">
              ...
              <div class="mt-4">
                <h3 class="text-lg font-medium">
                  Giulia's Overnight Repair Mask
                </h3>
                <p class="text-gray-600 text-sm mt-1">
    ...
    <footer class="bg-gray-900 text-white py-20">
      <div class="max-w-7xl mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div>
            <a href="/" class="font-['Pacifico'] text-2xl block mb-6"
              >Giulia Navarini</a
            >
          ...
          <div>
            ...
            <div class="flex space-x-4">
              <a
                href="https://instagram.com/giulianavarini"
                target="_blank"
              ...
              <a
                href="https://facebook.com/giulianavarini"
                target="_blank"
                class="w-10 h-10 flex items-center justify-center rounded-full bg-white/10 hover:bg-white/20 transition-colors"
              >
              ...
              <a
                href="https://twitter.com/giulianavarini"
                target="_blank"
                class="w-10 h-10 flex items-center justify-center rounded-full bg-white/10 hover:bg-white/20 transition-colors"
              >
        ...
        >
          <p>&copy; 2025 Giulia Navarini. All rights reserved.</p>
        </div>
      </div>
    </footer>
    <script>
